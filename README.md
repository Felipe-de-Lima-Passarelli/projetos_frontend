...
* Páginas responsivas desenvolvidas com **HTML, CSS, JS, TS e Bootstrap**.
...
* Aplicações que utilizam **tipagem forte**, **interfaces** e **boas práticas de TypeScript**.
* Projetos focados em escalabilidade e manutenção de código.
